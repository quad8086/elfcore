...
BOOST_AUTO_TEST_CASE(test_validate_date) {
  ...
  BOOST_TEST(validate_date(20180000) == false);
  ...
  BOOST_TEST(validate_date(2017123)  == false);
  ...
  BOOST_TEST(validate_date(20210730) == true);
  BOOST_TEST(validate_date(20210831) == true);
}
